<!--
	...
	@description Phase 2 stand-in for the G-code window.
...
<template>
	<div ref="body" class="placeholder">
		<h2>{{ title }}</h2>
		<p>Monaco, showing the generated program, line-mapped back to jobs.</p>
		<dl>
...
const { title, visible, source, frames, sizeLabel, state } = usePlaceholder('G-code', body);

<!--
	...
	@description Phase 2 stand-in for the Workspace window.
...
<template>
	<div class="placeholder" :class="{ hidden: !visible }">
		<h2>{{ title }}</h2>
		<p>The 2D editing view. SVG geometry, toolpaths, tabs, and the travel-move layer.</p>
...
const { title, visible } = usePlaceholder('Workspace');

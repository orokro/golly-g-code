<!--
	@file TimelineWindow.vue
	@description Phase 2 stand-in for the Timeline window.
...
<template>
	<div ref="body" class="placeholder">
		<h2>{{ title }}</h2>
		<p>Scrub the program and watch the tool move through it.</p>
		<dl>
...
const { title, visible, source, frames, sizeLabel, state } = usePlaceholder('Timeline', body);

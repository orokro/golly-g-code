<!--
	@file Preview2DWindow.vue
	@description Phase 2 stand-in for the Preview 2D window.
...
<template>
	<div ref="body" class="placeholder">
		<h2>{{ title }}</h2>
		<p>Flat render of the finished cut — the kerf, as it will look in the stock.</p>
		<dl>
...
const { title, visible, source, frames, sizeLabel, state } = usePlaceholder('Preview 2D', body);
